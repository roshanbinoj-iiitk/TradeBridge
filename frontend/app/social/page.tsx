      ...
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Connect with trusted lenders, share experiences, and build lasting relationships in our rental community
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="text-center hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Comprehensive profiles showing rental history, trust scores, and achievements
              </p>
              <div className="flex flex-wrap gap-1 justify-center">
                <Badge variant="outline" className="text-xs">Rental History</Badge>
                <Badge variant="outline" className="text-xs">Trust Scores</Badge>
          ...
          <Card className="text-center hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Follow trusted lenders, discover new products, and build your network
              </p>
              <div className="flex flex-wrap gap-1 justify-center">
                <Badge variant="outline" className="text-xs">Follow Users</Badge>
          ...
          <Card className="text-center hover:shadow-lg transition-shadow">
            <CardContent className="p-6">
              ...
              <div className="flex flex-wrap gap-1 justify-center">
                ...
                <Badge variant="outline" className="text-xs">Tips & Reviews</Badge>
              </div>
            </CardContent>
          </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {/* Demo profile cards */}
                    {[
                      { name: 'Sarah Johnson', type: 'Super Lender', rating: 4.9, rentals: 127 },
                      { name: 'Mike Chen', type: 'Trusted Member', rating: 4.8, rentals: 89 },
                      { name: 'Emma Wilson', type: 'Community Helper', rating: 4.9, rentals: 156 }
                    ].map((profile, index) => (
                      <Card key={index} className="text-center hover:shadow-md transition-shadow cursor-pointer">
                        <CardContent className="p-4">
                          ...
                          <Badge variant="outline" className="mb-2">{profile.type}</Badge>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="text-sm text-gray-600">
                    Experience our comprehensive user profiles with trust scores, rental history, and social features.
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Multi-dimensional trust scores, verification badges, and achievement system</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 bg-green-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Track user activities, rental history, and community engagement</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h4 className="font-medium">Professional Camera Kit</h4>
                            <p className="text-sm text-gray-600">High-quality DSLR camera with lenses - $45/day</p>
                          </div>
                        </div>
                        <SocialSharing
                          shareType="product"
                      ...
                      <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h4 className="font-medium">Tips for First-Time Renters</h4>
                            <p className="text-sm text-gray-600">Community forum post with helpful advice</p>
                          </div>
                        </div>
                        <SocialSharing
                          shareType="post"
                      ...
                      <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h4 className="font-medium">Sarah Johnson&apos;s Profile</h4>
                            <p className="text-sm text-gray-600">Trusted lender with 4.9★ rating and 127 successful rentals</p>
                          </div>
                        </div>
                        <SocialSharing
                          shareType="profile"
